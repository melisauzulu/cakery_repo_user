...
import 'package:cakery_app_users_app/widgets/shipment_address_design.dart';
import 'package:cakery_app_users_app/widgets/status_banner.dart';
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                        "Order at: " +
                            DateFormat("dd MMMM, yyyy - hh:mm aa").format(DateTime.fromMillisecondsSinceEpoch(int.parse(dataMap["orderTime"]))),
                      style: const TextStyle(fontSize: 17, color: Colors.grey),
                    ),
                  ),
                  const Divider(thickness: 5,),
                  orderStatus == "ended"
                      ? Image.asset("images_user/delivered.jpg")
                      : Image.asset("images_user/state.jpg"),
                  const Divider(thickness: 5,),
